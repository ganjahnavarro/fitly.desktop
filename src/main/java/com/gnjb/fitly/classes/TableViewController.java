...
import com.gnjb.fitly.common.TableRowDeleteButton;
import com.gnjb.fitly.common.TableRowEditButton;
import com.gnjb.fitly.common.TableRowViewButton;
import com.gnjb.fitly.model.IRecord;
...
public abstract class TableViewController extends ViewController {
	...
	protected Callback generateCellFactory(TableView<? extends IRecord> tableView, Action... actions) {
		Callback<TableColumn<? extends IRecord, Object>, TableCell<? extends IRecord, Object>> actionColumnCellFactory = new Callback<TableColumn<? extends IRecord, Object>, TableCell<? extends IRecord, Object>>() {
	...
	private HBox createButtonBar(TableView<? extends IRecord> tableView, TableColumn<? extends IRecord, Object> param,
